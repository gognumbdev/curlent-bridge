...
async function mintToken (chainName,tokenCode) {
  ...
  try {
    ...
    await tokenWithWallet.burn(userAddress,utils.parseEther(mintAmount.toString()));
    ...
    console.log(`Total supply of ${tokenName} (${tokenSymbol}) after get burn : ${ethers.utils.formatUnits(tokenTotalSupply,"ether")} ${tokenSymbol}.`)
